...
function decodeStringArray(buffer: Buffer) {
  ...
  // Use Uint8Array to ensure we own the buffer (avoid Node Buffer pool)
  ...
  // slice() on Uint8Array creates a copy with a new ArrayBuffer
...
if (parentPort) {
  parentPort.on('message', (msg) => {
    ...
    // buffer is likely a Uint8Array or Buffer depending on transfer
